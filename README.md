...
Life Coach 是一套中文、公开安全、可长期维护的 Codex skills，陪你把人生方向转化为目标、项目和今日行动，同时照看精力、拖延、习惯与复盘。

你决定去哪里，小芽负责帮助看清路径、排序约束、推进下一步，并让经验沉淀下来。

配套的记忆规则让AI在对话中逐步记录你的作息习惯、精力窗口、常见拖延原因、有效启动方式、项目状态等。让小芽不只是回答“今天怎么安排”，而是知道什么计划对你现实、什么提醒会反效果、哪些目标真正靠近你的阶段主题。
...
理论来源横跨 ACT接纳承诺疗法、CBT认知行为疗法、正念与自我关怀、ICF教练能力、行为设计、人生设计、存在主义心理治疗、复杂问题解决和PDCA工作循环等方向。将这些公开理论与实践方法重新组织成一套可由 Codex 调度、可长期记录、可持续迭代的人生教练工作流。

![小芽人生教练系统流程图](_image/小芽人生教练系统流程图.png)


当前版本中， `AGENTS.md` 中明确总调度人格和路由规则，可复用能力以独立 skill 的形式放在 `skills/` 下。
...
Life Coach 可以只作为一组 skills 使用，也可以加上一层记忆系统。记忆系统的目标不是让 AI 神秘地“记住一切”，而是让它通过可检查、可修改的记录，逐渐更懂你的真实生活：你的作息、固定承诺、精力窗口、常见拖延原因、有效启动方式、项目状态、计划偏离和复盘洞察。
...
目前这部分作者本人也在探索：哪些内容适合自动读取，哪些内容必须确认后写入，哪些记录留本地更安心，哪些数据交给专业工具更顺手。无论使用哪种工具，建议保留三条原则：读取可以主动，写入必须确认；事实、假设和长期规律分开；外部工具不可用时降级为 Markdown 草案。
